...
if ( ! class_exists( 'WC_Integration_Cebelcabiz' ) ) :
  ...
  class WC_Integration_Cebelcabiz extends WC_Integration {
    ...
    public function __construct() 
    {
      global $woocommerce;
      $this->id                 = 'cebelcabiz';
      $this->method_title       = __( 'Cebelca BIZ', 'cebelcabiz' );
      $this->method_description = __( 'An integration that connects WooCommerce to Cebelca BIZ for invoicing and optionally inventory.', 'cebelcabiz' );
      // Load the settings.
